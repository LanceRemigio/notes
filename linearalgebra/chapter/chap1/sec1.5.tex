...
\begin{theorem}[Linearly Dependent Subsets]
...
\begin{corollary}[Linearly Independent Subsets]\label{Corollary to Theorem 1.6}
...
\begin{theorem}[Adjoning Elements not in Linearly Independent Sets]\label{Theorem 1.7}
