...
\begin{theorem}[Dimension Theorem In Terms of Invertibility]\label{Fact 3}
...
\begin{theorem}[Invertibility of Linear Maps \( \iff \) Invertibility of Matrices]\label{Theorem 2.18}
...
\begin{corollary}\label{Corollary 2 to Theorem 2.18}
