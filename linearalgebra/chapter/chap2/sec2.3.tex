...
\begin{theorem}[Compositions are Linear]\label{Composition is Linear}
...
\begin{theorem}[Properties of Compositions in \( \mathcal{L}(V) \)]\label{Properties of Compositions}
...
\end{eg}
 ...
 \begin{theorem}[Compositions Represented by Product of Matrix Multiplication]\label{Theorem 2.11}
...
\begin{definition}[Kronecker Delta]\label{Kronecker Delta}
...
\begin{theorem}[Properties of Matrices]\label{prop of matrices} % theorem 2.12 in the book
...
\begin{theorem}[Marix Products Represented by Column Vectors]\label{Theorem 2.13} %Theorem 2.13
...
\begin{theorem}[Linear Maps and Matrix Products]\label{Theorem 2.14}
